# Generated by Django 3.1.2 on 2021-12-12 10:02
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('job_title', models.CharField(choices=[('employee', 'employee'), ('manager', 'manager')], max_length=150, null=True)),
                ('max_loan_auth', models.DecimalField(decimal_places=2, max_digits=10, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='branches',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('due_date', models.DateField(default=datetime.datetime(2022, 6, 10, 10, 2, 1, 331572, tzinfo=utc))),
